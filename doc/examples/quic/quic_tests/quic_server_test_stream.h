...
public:
    ...
    size_t __hash() const {
        ...
        switch(tag) {
            ...
            case 24: return 24 + hash_space::hash<quic_server_test_stream::frame__unknown_frame>()(quic_server_test_stream::frame::unwrap< quic_server_test_stream::frame__unknown_frame >((*this)));
    
            case 25: return 25 + hash_space::hash<quic_server_test_stream::frame__malicious_frame>()(quic_server_test_stream::frame::unwrap< quic_server_test_stream::frame__malicious_frame >((*this)));
    ...
    frame__ack_ecn__range__arr ack_ranges;
        size_t __hash() const { return hash_space::hash<unsigned>()(largest_acked)+hash_space::hash<int>()(ack_delay)+hash_space::hash<frame__ack_ecn__range__arr>()(ack_ranges);}
    };
...
public:
    ...
    unsigned long long max_early_data_size;
        size_t __hash() const { return hash_space::hash<unsigned long long>()(max_early_data_size);}
    };
    ...
    stream_data content;
        size_t __hash() const { return hash_space::hash<stream_data>()(content);}
    };
    struct tls__psk_identity {
    stream_data identity;
    unsigned long long obfuscated_ticket_age;
        size_t __hash() const { return hash_space::hash<stream_data>()(identity)+hash_space::hash<unsigned long long>()(obfuscated_ticket_age);}
    };
    ...
    stream_data psk_binder;
        size_t __hash() const { return hash_space::hash<vector__tls__psk_identity__>()(psk_identities)+hash_space::hash<stream_data>()(psk_binder);}
    };
    struct tls__pre_shared_key_server {
    unsigned long long selected_identity;
        size_t __hash() const { return hash_space::hash<unsigned long long>()(selected_identity);}
    };
    struct tls__random {
    ...
    stream_data ticket;
    vector__tls__extension__ extensions;
        size_t __hash() const { return hash_space::hash<unsigned long long>()(ticket_lifetime)+hash_space::hash<unsigned long long>()(ticket_age_add)+hash_space::hash<stream_data>()(ticket_nonce)+hash_space::hash<stream_data>()(ticket)+hash_space::hash<vector__tls__extension__>()(extensions);}
    };
    ...
    versions_bv supported_version;
        size_t __hash() const { return hash_space::hash<int>()(ptype)+hash_space::hash<unsigned>()(pversion)+hash_space::hash<cid>()(dst_cid)+hash_space::hash<cid>()(src_cid)+hash_space::hash<versions_bv>()(supported_version);}
    };
...
public:
    ...
    cid rcid;
        size_t __hash() const { return hash_space::hash<cid>()(rcid);}
    };
    struct loss_bits {
    ...
    versions_bv other_version;
        size_t __hash() const { return hash_space::hash<unsigned>()(chosen_version)+hash_space::hash<versions_bv>()(other_version);}
    };
    ...
    itoken integrity_token;
        size_t __hash() const { return hash_space::hash<int>()(ptype)+hash_space::hash<unsigned>()(pversion)+hash_space::hash<cid>()(dst_cid)+hash_space::hash<cid>()(src_cid)+hash_space::hash<stream_data>()(token)+hash_space::hash<itoken>()(integrity_token);}
    };
    ...
    unsigned seq_num;
    frame__arr payload;
        size_t __hash() const { return hash_space::hash<int>()(ptype)+hash_space::hash<unsigned>()(pversion)+hash_space::hash<cid>()(dst_cid)+hash_space::hash<cid>()(src_cid)+hash_space::hash<unsigned>()(seq_num)+hash_space::hash<frame__arr>()(payload);}
    };
    ...
    unsigned seq_num;
    frame__arr payload;
        size_t __hash() const { return hash_space::hash<int>()(ptype_i)+hash_space::hash<unsigned>()(pversion_i)+hash_space::hash<cid>()(dst_cid_i)+hash_space::hash<cid>()(src_cid_i)+hash_space::hash<stream_data>()(token_i)+hash_space::hash<unsigned>()(seq_num_i)+hash_space::hash<frame__arr>()(payload_i)+hash_space::hash<int>()(ptype)+hash_space::hash<unsigned>()(pversion)+hash_space::hash<cid>()(dst_cid)+hash_space::hash<cid>()(src_cid)+hash_space::hash<unsigned>()(seq_num)+hash_space::hash<frame__arr>()(payload);}
    };
    ...
    enum endpoint_id{endpoint_id__client,endpoint_id__client_alt,endpoint_id__client_vn,endpoint_id__server,endpoint_id__server_2,endpoint_id__mim};
    ...
    unsigned long long pkt_num_pos;
        size_t __hash() const { return hash_space::hash<bool>()(hdr_long)+hash_space::hash<unsigned>()(hdr_type)+hash_space::hash<cid>()(dcid)+hash_space::hash<cid>()(scid)+hash_space::hash<unsigned long long>()(payload_length)+hash_space::hash<unsigned long long>()(token_length)+hash_space::hash<unsigned long long>()(payload_length_pos)+hash_space::hash<unsigned long long>()(pkt_num_pos);}
    };
...
public:
    ...
    stream_data data;
    stream_data payload;
        size_t __hash() const { return hash_space::hash<bool>()(ok)+hash_space::hash<stream_data>()(data)+hash_space::hash<stream_data>()(payload);}
    };
...
class hash____tup__unsigned__unsigned__unsigned__cid__unsigned {
    ...
    bool crypto_reset;
    bool negocation_of_version_send_recv;
    ...
    bool _generating;
    cid the_cid;
    bool last_zrtt_pkt_set;
    unsigned long long h_retry;
    bool client_present_scid;
    bool token_saved;
    bool retry_client_test;
    bool zero_rtt_sent;
    bool negocation_of_version;
    ip__endpoint mim__ep;
	...
	udp_callbacks *net__impl__cb[6];             // the callbacks to ivy
...
const quic_version_vals[] = {
    ...
    { 0, NULL }
            ...
            quic_server_test_stream(quic_server_test_stream::cid the_cid, unsigned client_addr, unsigned server_addr, unsigned server_port, unsigned server_port_2, quic_server_test_stream::cid server_cid, unsigned client_port, unsigned client_port_alt, unsigned client_port_vn, unsigned long long max_stream_data);
    ...
    virtual void mid_handshake_event();
    ...
    virtual void imp__stop_handshake_event();
    ...
    virtual void imp__start_handshake_event();
    ...
    virtual void show_app_send_event(const stream_data& d);
    ...
    virtual void imp__show_connected(bool c1, quic_server_test_stream::cid c2);
    ...
    virtual void imp__mid_handshake_event();
    ...
    virtual void ext__show_tls_lower_send(const stream_data& bytes);
    ...
    virtual void ext__show_condi(bool b);
    ...
    virtual void imp__show_sdata(const stream_data& d);
    ...
    virtual void ext__frame__connection_close__handle(frame__connection_close f, quic_server_test_stream::cid scid, quic_server_test_stream::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void __init();
    virtual void show_pstats(quic_server_test_stream::cid scid, quic_packet_type e, unsigned pnum);
    ...
    virtual void imp__show_set_initial_keys(const stream_data& ik);
    ...
    virtual void show_version(unsigned ver);
    ...
    virtual unsigned ext__prot__show_pnum2(unsigned long long x);
    ...
    virtual void imp__show_dst_is_generated_handshake_data_event(bool dst);
    ...
    virtual void show_set_initial_keys(const stream_data& ik);
    ...
    virtual void stop_handshake_event();
    virtual quic_server_test_stream::tls_api__id ext__cid_to_us(quic_server_test_stream::cid c);
    ...
    virtual void start_handshake_event();
    ...
    virtual void imp__padding_packet_event(const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
    ...
    virtual unsigned long long ext__prot__get_pnum_len5(const stream_data& pkt);
    ...
    virtual void show_sdata(const stream_data& d);
    ...
    virtual void imp__show_condi(bool b);
    ...
    virtual void imp__show_act1();
    virtual void imp__show_act2();
    virtual void imp__show_act3();
    virtual void imp__show_tls_lower_send(const stream_data& bytes);
    virtual bool ext__test();
    ...
    virtual void ext__recv_packet_mim(const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
    ...
    virtual void show_dst_is_generated_handshake_data_event(bool dst);
    ...
    virtual void ext__show_act1();
    virtual void ext__show_act2();
    virtual void ext__show_act3();
    ...
    virtual void show_tls_send_event(const ip__endpoint& src, const ip__endpoint& dst, quic_server_test_stream::cid scid, quic_server_test_stream::cid dcid, const stream_data& data, unsigned long long pos, quic_packet_type e);
    ...
    virtual void imp__show_app_send_event(const stream_data& d);
    virtual void ext__padding_packet_event(const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
    ...
    virtual void enqueue_frame(quic_server_test_stream::cid scid, quic_server_test_stream::frame f, quic_packet_type e, bool probing);
    virtual stream_data ext__cid_to_bytes(quic_server_test_stream::cid c, unsigned len);
    virtual void recv_packet(const ip__endpoint& src, const ip__endpoint& dst, const quic_packet& pkt);
    ...
    virtual void show_connected(bool c1, quic_server_test_stream::cid c2);
    ...
    virtual void imp__recv_packet_mim(const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
...
bool operator ==(const quic_server_test_stream::frame &s, const quic_server_test_stream::frame &t){
    ...
    switch (s.tag) {
        ...
        case 24: return quic_server_test_stream::frame::unwrap< quic_server_test_stream::frame__unknown_frame >(s) == quic_server_test_stream::frame::unwrap< quic_server_test_stream::frame__unknown_frame >(t);
        case 25: return quic_server_test_stream::frame::unwrap< quic_server_test_stream::frame__malicious_frame >(s) == quic_server_test_stream::frame::unwrap< quic_server_test_stream::frame__malicious_frame >(t);
